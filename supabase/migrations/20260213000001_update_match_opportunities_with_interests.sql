-- Enhanced match_opportunities RPC with interests bonus
-- This version includes:
-- 1. Semantic similarity (vector search)
-- 2. Skills bonus (+0.1 per matching skill)
-- 3. Interests bonus (+0.1 per matching interest/cause)
-- 4. Skills penalty (-0.1 if no skills match)
-- 5. Location bonus (0.3 if location matches)
...
- Skills match (+0.1 per skill, -0.1 penalty if no match)
- Interests match (+0.1 per matching cause/interest)
- Location match (+0.3 bonus)';
